...
public class SecurityConfig {
  ...
  @Bean SecurityFilterChain chain(HttpSecurity http)throws Exception{return http
    ...
    .authorizeHttpRequests(auth->auth.requestMatchers("/api/auth/**","/swagger-ui/**","/swagger-ui.html","/v3/api-docs/**","/h2-console/**","/uploads/**","/demo-horses/**").permitAll().anyRequest().authenticated())
